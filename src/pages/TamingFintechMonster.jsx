          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="space-y-6 text-neutral-300 text-base md:text-lg leading-relaxed max-w-3xl">
              <p>
                ...
                <em className="text-neutral-400">Gap: pre/post adoption and satisfaction baselines were not measured before the system shipped; comparable instrumentation post-rollout is being pulled.</em>
              </p>
              ...
              <ul className="space-y-3 list-disc pl-6 marker:text-purple-400">
                ...
                <li>
                  ...
                  <em className="text-neutral-400">Gap: ticket-volume delta not captured at the time.</em>
                </li>
