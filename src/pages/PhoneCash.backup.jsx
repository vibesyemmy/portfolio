      ...
      <main className="min-h-screen bg-neutral-950 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 py-16">
          ...
          <div className="max-w-4xl mx-auto mt-24">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="col-span-1">
                <h2 className="text-xl font-semibold mb-4 md:mb-0 text-neutral-200">Problem</h2>
              </div>
          ...
          <div className="max-w-4xl mx-auto mt-24">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="col-span-1">
                <h2 className="text-xl font-semibold mb-4 md:mb-0 text-neutral-200">Goal</h2>
              </div>
              <div className="col-span-1 md:col-span-2 space-y-8">
                <p className="text-lg text-neutral-300 leading-relaxed">
          ...
          <div className="max-w-4xl mx-auto mt-24">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="col-span-1">
                <h2 className="text-xl font-semibold mb-4 md:mb-0 text-neutral-200">Testing</h2>
              </div>
              <div className="col-span-1 md:col-span-2 space-y-8">
                <p className="text-lg text-neutral-300 leading-relaxed">
          ...
          <div className="max-w-4xl mx-auto mt-24">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="col-span-1">
                <h2 className="text-xl font-semibold mb-4 md:mb-0 text-neutral-200">Iteration</h2>
              </div>
              <div className="col-span-1 md:col-span-2 space-y-8">
                <p className="text-lg text-neutral-300 leading-relaxed">
