---
title: "Lingawa: Learn the language your grandmother speaks"
summary: Solo-designed a 7-modality language learning platform serving 6,000+ diaspora learners, $1.1M raised, 5.0★ on both app stores, 4.9 Trustpilot.
client: Lingawa
...
<Metrics
  items={[
    ...
    { value: '6,000+', label: 'Diaspora learners' },
...
{/* ═══════════════════════════════════════════
   IMAGE NOTE — replace with actual screenshots
   ├─ web-before.webp: Old web platform, cluttered nav, no responsive layout, inconsistent UI
   └─ mobile-after.webp: Lingawa mobile home screen, clean onboarding, modality-first nav
   ═══════════════════════════════════════════ */}
<MediaGrid
  cols={2}
  items={[
    ...
    { src: '/lingawa/mobile-after.webp', caption: 'Mobile app home screen: clean onboarding, modality-first navigation, localised content.' },
  ]}
/>
...
{/* ═══════════════════════════════════════════
   IMAGE NOTE — replace with actual research artifacts
   ├─ research-affinity-map.webp: Affinity map from 18 interviews — post-its, clusters, comprehension-strength pattern highlighted
   └─ research-comprehension-gap.webp: Bar chart or diagram — listening vs speaking scores, 4× gap emphasised
   ═══════════════════════════════════════════ */}
<MediaGrid
  cols={2}
  items={[
...
{/* ═══════════════════════════════════════════
   IMAGE NOTE — replace with actual design system screenshot
   └─ design-system-components.webp: Figma component library — buttons, inputs, progress indicators, nav bars, avatars on token grid
   ═══════════════════════════════════════════ */}
...
{/* ═══════════════════════════════════════════
   IMAGE NOTE — existing combo images cover 6/7 modalities. Replace with individual screenshots when ready:
   ├─ modality-lesson-slides.webp: Structured instruction, progress bar, localised visual cues
   ├─ modality-vocab-drills.webp: Single word focus, minimal UI, correct/incorrect feedback states
   ├─ modality-matching-game.webp: Card grid, 48px+ targets, timer, celebration animation
   ├─ modality-dialogue-practice.webp: Chat UI, speaker attribution bubbles, turn-by-turn flow
   ├─ modality-sentence-construction.webp: Word bank (Normal) + free-text input (Advanced) tiers
   ├─ modality-story-reader.webp: Long-form text, minimal chrome, comfortable line-height
   └─ modality-practice-hub.webp: Progress rings, modality cards, personalised recommendations
   ═══════════════════════════════════════════ */}
<MediaFull
...
{/* ═══════════════════════════════════════════
   IMAGE NOTE — existing video covers kids mode well. Optionally add adult-vs-kids comparison:
   ├─ adult-mode.webp: Full dialogue interface, speaker bubbles, turn-taking, cultural context notes
   └─ kids-mode.webp: Simplified nav, 56px touch targets, larger type, mascot-led guidance
   ═══════════════════════════════════════════ */}
<MediaFull
  src="/kids.mp4"
...
{/* ═══════════════════════════════════════════
   IMAGE NOTE — replace with actual mascot journey composite
   └─ mascot-journey.webp: One character across emotional beats — onboarding guide → exercise coach → celebration/states
   ═══════════════════════════════════════════ */}
...
{/* ═══════════════════════════════════════════
   IMAGE NOTE — replace with actual before/after brand comparison
   ├─ old-brand.webp: Previous brand identity — logo, palette, typography, web-only
   └─ new-brand.webp: New brand identity — logo, palette, typography, mobile-native
   ═══════════════════════════════════════════ */}
<MediaGrid
  cols={2}
  items={[
...
{/* ═══════════════════════════════════════════
   IMAGE NOTE — replace with actual store badges (screenshots from Play Store, App Store, Trustpilot)
   ├─ trustpilot.webp: Trustpilot rating badge — 4.9★, 200+ reviews
   ├─ play-store.webp: Google Play Store listing — 5.0★, 1,000+ downloads
   └─ app-store.webp: Apple App Store listing — 5.0★, 2,500+ downloads
   ═══════════════════════════════════════════ */}
<StoreBadges
  items={[
    { src: '/lingawa/trustpilot.webp', alt: 'Lingawa on Trustpilot — 4.9★ rating, 200+ reviews', caption: 'Trustpilot' },
    { src: '/lingawa/play-store.webp', alt: 'Lingawa on Google Play Store — 5.0★ rating, 1,000+ downloads', caption: 'Play Store' },
    { src: '/lingawa/app-store.webp', alt: 'Lingawa on Apple App Store — 5.0★ rating, 2,500+ downloads', caption: 'App Store' },
  ]}
/>
...
{/* ═══════════════════════════════════════════
   IMAGE NOTE — replace with actual learner collage
   └─ user-testimonials-collage.webp: Composite of learner faces/quotes in-context — UK, US, Nigeria
   ═══════════════════════════════════════════ */}
...
{/* ═══════════════════════════════════════════
   IMAGE NOTE — replace with actual before/after token comparison
   ├─ before-system.webp: Screens before tokens — inconsistent spacing, mixed type scale, visual drift
   └─ after-system.webp: Same screens after tokens — 8px grid, unified type, coherent
   ═══════════════════════════════════════════ */}
<MediaGrid
  cols={2}
  items={[
