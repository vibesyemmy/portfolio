...
{/* IMAGE NOTE — add Figma Community listing page screenshot
   └─ listing.webp: The actual Community listing — thumbnail, description, category tags, install button, ratings
   This section describes the listing at length; showing it makes the distribution story concrete. */}
