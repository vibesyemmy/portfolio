...
<MediaFull src="/fragment-1.webp" width="wide" caption="Five products, five visual languages — the fragmentation users felt every time they moved between surfaces." />
...
<MediaFull src="/north-star.webp" width="wide" caption="The bet: one UI kit and one component library feeding every product — design efficiency in, consistent experience out." />
...
<MediaFull src="/atoms.webp" width="wide" caption="Atoms up — color, states, inputs, and controls assembled from one shared foundation." />
...
<MediaGrid
  cols={2}
  items={[
    { src: '/design-token.webp', caption: 'Semantic tokens, light and dark from a single source.' },
    { src: '/grid-system.webp', caption: 'A 4px spacing and layout grid across every screen.' },
  ]}
/>
...
<MediaFull src="/component-library.webp" width="wide" caption="Poseidon's documentation — every component shipped with props, presets, and a live preview." />
...
<MediaFull src="/hydrogen-ds.webp" width="container" caption="Poseidon in Figma — auto-layout, variants, and variables, accessible by default." />
...
<MediaFull src="/conclusion.webp" width="container" caption="One company, one language — HydrogenPay after Poseidon." />
