...
<Gallery
  items={[
    { src: '/demo-img/hotel-beyond-1.jpg', alt: 'Stay hub — SPA, room service, and self-checkout cards alongside do-not-disturb and schedule-wake-up-call controls.' },
    { src: '/demo-img/hotel-beyond-2.jpg', alt: 'Room service menu — breakfast dishes with a running order summary and total on the right.' },
    { src: '/demo-img/hotel-beyond-3.jpg', alt: 'Spa treatments — booking a Short SPA Circuit by choosing an available time slot.' },
    { src: '/demo-img/hotel-beyond-4.jpg', alt: 'Self checkout — late-checkout and extend-stay offers beside an itemized bill.' },
    { src: '/demo-img/hotel-beyond-5.jpg', alt: 'Complete payment — scan a QR code to pay from your phone, with a front-desk fallback.' },
  ]}
/>
...
<MediaGrid
  ...
  items={[
    ...
    { src: '/booking-room-service.mp4', poster: '/booking-room-service-poster.webp', caption: 'Room service: browse the menu, build an order, and confirm — no phone call.' },
  ]}
/>
