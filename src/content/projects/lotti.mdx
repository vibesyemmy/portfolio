...
<div class="cs-image-placeholder">
  ...
  <p class="cs-image-placeholder__desc">Hero image — a wide device mockup showing Lotti's My Daily timeline on both mobile and desktop side by side. The timeline displays actual tasks with their real-world times, colored time blocks in the background, and faded cards showing interrupted work.</p>
  <p class="cs-image-placeholder__caption">Caption: Lotti's honest timeline: planned time blocks render as background context, actual task cards appear at real work times.</p>
</div>
