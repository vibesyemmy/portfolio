...
{/* IMAGE NOTE — capture My Daily timeline screenshot from Figma
   └─ lotti/my-daily.webp: The honest timeline — planned blocks as background context,
      actual task cards at real work times, linked multi-session cards with fade states */}
...
{/* IMAGE NOTE — capture Health Score Card comparison from Figma
   └─ lotti/health-score.webp: The three directions — action-focused (progress ring + blocker),
      metric dashboard (sparkline + 2×2 grid), status-first (banner + demoted score) */}
