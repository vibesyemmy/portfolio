...
<div class="cs-trio">
  <figure>
    <a href="/lotti/audit-my-daily.jpg" target="_blank">
      <img src="/lotti/audit-my-daily.jpg" alt="Original My Daily planner: cluttered timeline with overlapping time budgets, Over budget warning, and no clear visual hierarchy" loading="lazy" />
    </a>
    <figcaption>My Daily: cluttered, no clear hierarchy</figcaption>
  </figure>
  <figure>
    <a href="/lotti/audit-task-list.jpg" target="_blank">
      <img src="/lotti/audit-task-list.jpg" alt="Original task list view: entries displayed with no section title, unclear information architecture" loading="lazy" />
    </a>
    <figcaption>Task list: no title, unclear structure</figcaption>
  </figure>
  <figure>
    <a href="/lotti/audit-task-detail.jpg" target="_blank">
      <img src="/lotti/audit-task-detail.jpg" alt="Original task detail screen: overloaded with competing labels, checklists, and linked entries with no visual priority" loading="lazy" />
    </a>
    <figcaption>Task detail: too many things competing</figcaption>
  </figure>
</div>
